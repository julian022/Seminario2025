...
public class ReportService {
    ...
    public ReportService(MaterialService materialService) {
    ...
    public void exportMaterialsToExcel(HttpServletResponse response) throws IOException {
        ...
        for (Material material : materiales) {
            ...
            String proveedorNombre = (material.getProveedor() != null)
                    ? material.getProveedor().getNombre()
                    : "Sin proveedor";
            row.createCell(5).setCellValue(proveedorNombre);
        }
